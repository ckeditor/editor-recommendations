 ...
 * UI: ON/OFF feature, usually represented as a switch button with the "<span class="fa fa-bold" title="Bold" aria-hidden="true"></span><span class="sr-only">Bold</span>" icon
