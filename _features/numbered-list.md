 ...
 * UI: ON/OFF feature, usually represented as a switch button with the "<span class="fa fa-list-ol" title="Numbered List" aria-hidden="true"></span><span class="sr-only">Numbered List</span>" icon
